	...
	return (
		<div className='unauthorize bg-beige bg-cover min-h-screen flex flex-row'>
			<div className='m-auto items-center border-2 border-cafe p-6'>
				...
				<p className='text-lg font-[itf] text-cafe'>You are not authorize to access this page</p>
				<div className='flex flex-row items-center me-auto mt-4'>
					<button className='border-cafe border-2 m-auto p-4 text-lg font-[itf] text-cafe' onClick={logout}>
						{' '}
						Go Back
					</button>
				</div>

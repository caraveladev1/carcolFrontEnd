export const FILTER_NAMES = {
	...
	VIEW_CONTAINER: ['office', 'initialDate', 'finalDate', 'packaging', 'contract', 'destination', 'ico'],
	EDIT_CONTAINER: [
		'booking',
		'dateLandingPort',
		'estimatedArrival',
...
export const BOOKING_AND_DATES_LABELS = ['booking', 'dateLandingPort', 'estimatedArrival', 'exportDate'];
